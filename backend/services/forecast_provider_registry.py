...
PROVIDERS = {
    "gistda": {
        ...
        "license": "Permission required before public use",
        "license_url": "https://pm25.gistda.or.th/",
    ...
    "openmeteo_cams": {
        ...
        "license": "CC BY 4.0; free endpoint restricted to non-commercial use",
    ...
    "openweather": {
        ...
        "temporal_resolution_hours": 1,
        "spatial_resolution_km": None,
        "license": "OpenWeather subscription terms",
        "license_url": "https://openweathermap.org/api/air-pollution",
        "issued_time_kind": "retrieved_at",
        ...
        summaries.append(
            {
                ...
                "temporal_resolution_hours": metadata["temporal_resolution_hours"],
                "spatial_resolution_km": metadata["spatial_resolution_km"],
                "license": metadata["license"],
                "license_url": metadata["license_url"],
                "issued_time_kind": metadata["issued_time_kind"],
